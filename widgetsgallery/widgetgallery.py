...
from PyQt6.QtGui import (QCursor, QDesktopServices, QGuiApplication, QIcon,
                           ...
                           QStandardItemModel, QFileSystemModel, QDesktopServices)
...
def launch_module_help():
    QDesktopServices.openUrl(QUrl(help_url("qtwidgets-index"), QUrl.ParsingMode.TolerantMode))
...
class WidgetGallery(QDialog):
    ...
    def __init__(self):
        ...
        # Pyside doesn't use enums for attributes. PyQt does.  
    ...
    def create_itemview_tabwidget(self):
        ...
        # another case of PyQt Enums. which, imho, is better.
